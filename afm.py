...
Original file is located at
    https://colab.research.google.com/drive/1gMzOrPNQ_w-A-SPtVDfYzbBW0S9rYKHX
"""
...
if __name__ == "__main__":
    # 读取数据
    data = pd.read_csv('/Treatment.txt')
    ...
    history.compile(optimizer="adam", 
                ...
                metrics=["binary_crossentropy", tf.keras.metrics.AUC(name='auc'), keras.metrics.Recall()])
